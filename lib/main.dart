...
void main() async {
  ...
  // ── Flutter framework errors → print to console ──
  // Sentry removed for now — flutter 3.24.0 is incompatible with sentry_flutter ^8.9
  // Add back after upgrading Flutter to 3.27+
